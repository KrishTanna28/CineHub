...
export class PointsCalculator {
   ...
   */
  static calculateQualityPoints(review) {
    let points = 0;
    const details = {};
   ...
   */
  static calculateEngagementPoints(review) {
    let points = 0;
    const details = {};
   ...
   */
  static calculateTimingPoints(review, context) {
    let points = 0;
    const details = {};
   ...
   */
  static calculateDiversityPoints(user, review) {
    let points = 0;
    const details = {};
   ...
   */
  static calculateReplyPoints(reply, review) {
    let points = 0;
    const details = {};
   ...
   * Calculate penalties
   */
  static calculatePenalties(review, user) {
    let points = 0;
    const details = {};
   ...
   */
  static getLevelFromPoints(totalPoints) {
    const levels = [
